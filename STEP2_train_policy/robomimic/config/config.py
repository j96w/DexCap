...
class Config(dict):
    ...
    # TODO: With below two functions, multiprocess have issue. Need to fix it. Without these two functions, training has issue...
    ...
    # TODO: Conflict between training and multiprocess inference, below two functions.
